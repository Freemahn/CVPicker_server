var quizApp = angular.module("QuizApp", ['ngSanitize', 'ui.bootstrap', 'webcam']);
...
quizApp.directive("iscorecard", ['QuizService', function (QuizService, $window) {
    return {
        restrict: 'E',
        scope: {},
        controller: function ($scope, $window, $http, $location) {
            ...
            navigator.getUserMedia({
                ...
                function (stream) {
                    ...
                    //$scope.srcVideo = $window.URL.createObjectURL(stream);
                },
                function (err) {
                    console.log(err)
                }
